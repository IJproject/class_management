...
const submit = () => {
    ...
    form.put(route('owner.news.update', form.id), {
    });
}
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">お知らせ編集</h2>
        </template>
        <div>
            <form @submit.prevent="submit">
                ...
                <button type="submit" class="mt-2 mb-4 py-2 px-4 bg-gray-500 text-white rounded-md hover:bg-gray-400">更新</button>
            </form>
        </div>
    </AuthenticatedLayout>
</template>